...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#board{\n  width: 60vw;\n  height: 60vh;\n  display: grid;\n  grid-template-rows: repeat(8,1fr);\n  border: 1px solid black;\n}\n.row{\n  display: grid;\n  grid-template-columns: repeat(8,1fr);\n}\n#board .row:nth-child(even) .board-square:nth-child(odd){\n  background-color: white;\n}\n#board .row:nth-child(even) .board-square:nth-child(odd){\n  background-color: black;\n}\n\n#board .row:nth-child(odd) .board-square:nth-child(even){\n  background-color: black;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,WAAW;EACX,YAAY;EACZ,aAAa;EACb,iCAAiC;EACjC,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,oCAAoC;AACtC;AACA;EACE,uBAAuB;AACzB;AACA;EACE,uBAAuB;AACzB;;AAEA;EACE,uBAAuB;AACzB","sourcesContent":["#board{\n  width: 60vw;\n  height: 60vh;\n  display: grid;\n  grid-template-rows: repeat(8,1fr);\n  border: 1px solid black;\n}\n.row{\n  display: grid;\n  grid-template-columns: repeat(8,1fr);\n}\n#board .row:nth-child(even) .board-square:nth-child(odd){\n  background-color: white;\n}\n#board .row:nth-child(even) .board-square:nth-child(odd){\n  background-color: black;\n}\n\n#board .row:nth-child(odd) .board-square:nth-child(even){\n  background-color: black;\n}"],"sourceRoot":""}]);
// Exports
...
*/
  ...
  findPath(destination, position = this.position, list = this.adjacencyList) {
    ...
    while (queue.length !== 0) {
      ...
      if (list.get(String(firstInQ)).some((el) => lodash_isequal__WEBPACK_IMPORTED_MODULE_0___default()(el, destination))) {
...
/* harmony import */ var _modules_knightLogic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/knightLogic */ "./src/modules/knightLogic.js");
/* harmony import */ var _modules_chessBoard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/chessBoard */ "./src/modules/chessBoard.js");
