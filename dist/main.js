...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n#board{\n  width: 60vw;\n  height: 60vh;\n  display: grid;\n  grid-template-rows: repeat(8,1fr);\n  border: 1px solid black;\n}\n.row{\n  display: grid;\n  grid-template-columns: repeat(8,1fr);\n}\n#board .row:nth-child(even) .board-square:nth-child(odd){\n  background-color: white;\n}\n#board .row:nth-child(even) .board-square:nth-child(odd){\n  background-color: black;\n}\n\n#board .row:nth-child(odd) .board-square:nth-child(even){\n  background-color: black;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":";AACA;EACE,WAAW;EACX,YAAY;EACZ,aAAa;EACb,iCAAiC;EACjC,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,oCAAoC;AACtC;AACA;EACE,uBAAuB;AACzB;AACA;EACE,uBAAuB;AACzB;;AAEA;EACE,uBAAuB;AACzB","sourcesContent":["\n#board{\n  width: 60vw;\n  height: 60vh;\n  display: grid;\n  grid-template-rows: repeat(8,1fr);\n  border: 1px solid black;\n}\n.row{\n  display: grid;\n  grid-template-columns: repeat(8,1fr);\n}\n#board .row:nth-child(even) .board-square:nth-child(odd){\n  background-color: white;\n}\n#board .row:nth-child(even) .board-square:nth-child(odd){\n  background-color: black;\n}\n\n#board .row:nth-child(odd) .board-square:nth-child(even){\n  background-color: black;\n}"],"sourceRoot":""}]);
// Exports
